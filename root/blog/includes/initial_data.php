...
$initial_data = array(
	...
	'UA_GREY_STAR_SRC'		=> $phpbb_root_path . 'blog/styles/' . $blog_template . '/images/star_grey.gif',
	'UA_GREEN_STAR_SRC'		=> $phpbb_root_path . 'blog/styles/' . $blog_template . '/images/star_green.gif',
	'UA_RED_STAR_SRC'		=> $phpbb_root_path . 'blog/styles/' . $blog_template . '/images/star_red.gif',
	'UA_ORANGE_STAR_SRC'	=> $phpbb_root_path . 'blog/styles/' . $blog_template . '/images/star_orange.gif',
	'UA_MAX_RATING'			=> $config['user_blog_max_rating'],
	'UA_MIN_RATING'			=> $config['user_blog_min_rating'],

	'MINI_POST_IMG'			=> $phpbb_root_path . 'blog/styles/' . $blog_template . '/images/icon_post_target.gif',
);
