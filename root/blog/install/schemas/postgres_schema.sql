...
CREATE TABLE phpbb_blogs (
	...
	blog_approved boolean DEFAULT '1' NOT NULL CHECK (blog_approved >= 0),
	blog_reported boolean DEFAULT '0' NOT NULL CHECK (blog_reported >= 0),
	...
	blog_edit_locked boolean DEFAULT '0' NOT NULL CHECK (blog_edit_locked >= 0),
	...
	blog_attachment boolean DEFAULT '0' NOT NULL CHECK (blog_attachment >= 0),
...
CREATE TABLE phpbb_blogs_plugins (
	...
	plugin_enabled boolean DEFAULT '0' NOT NULL CHECK (plugin_enabled >= 0),
...
CREATE TABLE phpbb_blogs_reply (
	...
	reply_approved boolean DEFAULT '1' NOT NULL CHECK (reply_approved >= 0),
	reply_reported boolean DEFAULT '0' NOT NULL CHECK (reply_reported >= 0),
	enable_bbcode boolean DEFAULT '1' NOT NULL CHECK (enable_bbcode >= 0),
	enable_smilies boolean DEFAULT '1' NOT NULL CHECK (enable_smilies >= 0),
	enable_magic_url boolean DEFAULT '1' NOT NULL CHECK (enable_magic_url >= 0),
	bbcode_bitfield varchar(255) DEFAULT '' NOT NULL,
	...
	reply_edit_locked boolean DEFAULT '0' NOT NULL CHECK (reply_edit_locked >= 0),
	...
	reply_attachment boolean DEFAULT '0' NOT NULL CHECK (reply_attachment >= 0),
...
CREATE TABLE phpbb_blogs_users (
	...
	instant_redirect boolean DEFAULT '1' NOT NULL CHECK (instant_redirect >= 0),
	PRIMARY KEY (user_id)
);
