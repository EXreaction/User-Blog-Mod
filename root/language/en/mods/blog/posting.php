...
$lang = array_merge($lang, array(
	...
	'BLOG_SUBSCRIPTION_NOTICE_EMAIL'	=> 'This is an automatically dispatched message from the User Blog Mod notifying you that a comment has been made to this blog entry by %2$s: /r/n %1$s /r/n /r/n /r/n If you would like to no longer recieve these notices click the following link to unsubscribe:/r/n%3$s',
	...
	'DELETE_BLOG_WARN'					=> 'Once deleted, only a moderator or administrator can un-delete this blog entry',
	'DELETE_REPLY_CONFIRM'				=> 'Are you sure you want to delete this comment?',
	'DELETE_REPLY_WARN'					=> 'Once deleted, only a moderator or administrator can un-delete this comment',
	...
	'NOT_SUBSCRIBED_BLOG'				=> 'You are not subscribed to this blog entry.',
	'NOT_SUBSCRIBED_USER'				=> 'You are not subscribed to this user.',
	'NO_PERMISSIONS_SINGLE'				=> 'Can not read or reply to this blog entry.',

	'PERMANENTLY_DELETE_BLOG_CONFIRM'	=> 'Are you sure you want to permanently delete this blog entry?  This can not be un-done.',
	...
	'REPLY_ALREADY_DELETED'				=> 'This comment has already been deleted.',
	...
	'REPLY_IS_DELETED'					=> 'This comment was deleted by %1$s on %2$s.  Click <b>%3$shere%4$s</b> to un-delete this reply.',
	...
	'USER_SUBSCRIPTION_NOTICE_EMAIL'	=> 'This is an automatically dispatched message from the User Blog mod notifying you that a new blog entry has been posted by %1$s.  You can view the blog here:/r/n %2$s /r/n /r/n /r/n If you would like to no longer recieve these notices click the following link to unsubscribe:/r/n%3$s',
